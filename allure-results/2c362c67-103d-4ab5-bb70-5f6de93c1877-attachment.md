...
- Name: functional\login.functional.spec.ts >> Login - Functional TEST >> TC_009 - Verify Username textbox is visible
- Location: tests\functional\login.functional.spec.ts:24:5
