...
- Name: functional\login.functional.spec.ts >> Login - Functional TEST >> TC_008 - Verify OrangeHRM logo is visible
- Location: tests\functional\login.functional.spec.ts:19:7
