...
```
TypeError: expect(https://opensource-demo.orangehrmlive.com/web/index.php/auth/login).toContain(/auth\/login/) // indexOf

Matcher error: expected value must be a string if received value is a string

Expected has type:  regexp
Expected has value: /auth\/login/
Received has type:  string
Received has value: "https://opensource-demo.orangehrmlive.com/web/index.php/auth/login"
```
...
> 15 |     expect(await loginPage.getCurrentUrl()).toContain(/auth\/login/);
     |                                             ^ TypeError: expect(https://opensource-demo.orangehrmlive.com/web/index.php/auth/login).toContain(/auth\/login/) // indexOf
  16 |   })
  17 | 
  18 | 
